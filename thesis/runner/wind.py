...
def execute_job(runner_spec):
    ...
    is_file_log = runner_spec.get('file_log', False)
    is_stream_log = runner_spec.get('stream_log', True)
    if is_file_log:
    ...
    if runner_spec.get('save_result', True):
