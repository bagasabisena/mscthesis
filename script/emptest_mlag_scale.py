...
def run_test(horizons, start, finish, output_feature, input_feature, l=1, time_as_feature=False, scale_x=True):
    result = []
...
for l in lags:
    ...
    result_df = run_test(horizons, start, finish, output_feature, input_feature, l=l, time_as_feature=False)
